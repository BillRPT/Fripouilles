...
public class V_rechercherarticle extends JPanel {
    ...
    public V_rechercherarticle() {
        ...
        btnValider.addActionListener(new rechercherArticle());
    }

    class rechercherArticle implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
            ...
            if (!libelleArt.getText().isEmpty()) {
                ...
                boolean articleTrouve = Modele.rechercherArticle(libelle);
