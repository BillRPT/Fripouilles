...
import Vues.Benevole.ArtCat.V_xmlconsulterartcat.RechercherArtCat;
import Vues.Benevole.Article.V_csvarticle;
import Vues.Benevole.Article.V_xmlarticle;

public class V_csvconsulterartcat extends JPanel {
    private JTextField libelleCat;
    private JButton btnValider;
    private JLabel messageLabel;
    private V_principal vPrincipal;
 
    public V_csvconsulterartcat(V_principal vPrincipal) {
        ...
        JLabel titreLabel = new JLabel("Consulter les articles d'un catalogue CSV :");
            ...
            if (!libelleCat.getText().isEmpty()) {
                if (Modele.rechercherCatalogue(libelleCat.getText())) {
                    if (vPrincipal != null) {
                        ...
                        vPrincipal.add(new V_csvarticle(Modele.consulterArtCat(libelleCat.getText())));
