...
public class V_jsonconsulterartcat extends JPanel {
    ...
    public V_jsonconsulterartcat(V_principal vPrincipal) { 
        ...
        JLabel titreLabel = new JLabel("Consulter les articles d'un catalogue JSON :");
            ...
            if (!libelleCat.getText().isEmpty()) {
                if (Modele.rechercherCatalogue(libelleCat.getText())) {
                    if (vPrincipal != null) {
                        ...
                        vPrincipal.add(new V_jsonarticle(Modele.consulterArtCat(libelleCat.getText())));
