...
public class V_supprimercatalogue extends JPanel {
    private JTextField libelleArt;
    private JButton btnValider;
    private JLabel messageLabel;
    private GridBagConstraints gbc;

    public V_supprimercatalogue() {
        ...
        btnValider = new JButton("Supprimer le catalogue");
        gbc.gridx = 0;
        gbc.gridy = 1;
        ...
        btnValider.addActionListener(new supprimerCatalogue());
    }

    class supprimerCatalogue implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
            ...
            if (!libelleArt.getText().isEmpty()) {
                ...
                boolean articleSupprime = Modele.supprimerCatalogue(libelle);
